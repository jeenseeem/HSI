    ...
    >
      ...
      <div className="relative z-20 w-full h-full flex items-center justify-center p-0 md:p-4 sm:p-8 pointer-events-none">
        <div 
          ...
          className="w-full h-full overflow-hidden pointer-events-none lg:pointer-events-auto md:pr-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex items-center justify-center"
        >
          <div className="w-full max-w-[1600px] relative flex items-center justify-center min-h-full">
            <div className="flex items-center justify-center w-full h-full relative">
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                className="relative z-10 w-[75vh] h-[75vw] md:w-[100%] md:h-auto lg:w-[95%] xl:w-[90%] max-w-none mx-auto rotate-90 md:rotate-0 flex items-center justify-center"
              >
                <motion.div 
                ...
                >
                  <img 
                    ...
                    alt="Paper Record" 
                    className="w-[75vh] h-[75vw] md:w-full md:h-auto object-contain md:object-cover opacity-90 mix-blend-multiply select-none pointer-events-none"
                    draggable="false"
                  />
